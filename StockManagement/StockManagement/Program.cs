namespace StockManagement
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            string path = @"C:\Users\yashw\source\repos\StockManagement\StockManagement\Stock.json";
            ...
            Console.WriteLine("The  total value for Common Stocks is : "+ total);
            Console.WriteLine();
            ...
            Console.WriteLine("The  total value for Preferred Stocks is : "+ total1);
            Console.WriteLine();
            ...
            Console.WriteLine("The  total value for Hybrid Stocks is : "+ total2);
            Console.WriteLine();
        }
    }
}